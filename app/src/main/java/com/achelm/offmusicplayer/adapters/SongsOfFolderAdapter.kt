...
class SongsOfFolderAdapter(private val activity: Activity, private var musicList: ArrayList<Music>, private val playlistDetails: Boolean = false,
                           private val selectionActivity: Boolean = false) : RecyclerView.Adapter<SongsOfFolderAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        when {
            ...
            selectionActivity -> {
                ...
                holder.button.setOnClickListener {
                    when {
                        SongsOfFolderActivity.search -> sendIntent(ref = "SongsOfFolderAdapterSearch", pos = position)

                        musicList[position].id == PlayerActivity.nowPlayingId ->
                            sendIntent(ref = "NowPlaying", pos = PlayerActivity.songPosition)

                        else -> sendIntent(ref = "SongsOfFolderAdapter", pos = position)
                    }
                }
            }
        }
