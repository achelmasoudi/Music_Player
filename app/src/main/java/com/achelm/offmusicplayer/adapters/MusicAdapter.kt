...
import com.achelm.offmusicplayer.activities.PlaylistDetailsActivity
...
import com.achelm.offmusicplayer.fragments.PlaylistFragment
...
class MusicAdapter(private val activity: Activity, private var musicList: ArrayList<Music>,
                   private val playlistDetails: Boolean = false, private val selectionActivity: Boolean = false ,
                   private var searchActivity: Boolean = false) : RecyclerView.Adapter<MusicAdapter.MyViewHolder>() {
    ...
    class MyViewHolder(i: View) : RecyclerView.ViewHolder(i) {
        ...
        val checkedIcon: ImageView = i.findViewById(R.id.musicCardItem_checkedIconId)
    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        var view = LayoutInflater.from(activity).inflate(R.layout.music_card_item , parent , false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        when {
            ...
            selectionActivity -> {
                holder.button.setOnClickListener {
                    if (addSong(musicList[position])) {
                        holder.button.setBackgroundColor(ContextCompat.getColor(activity, MainActivity.currentTheme_playerActivity[MainActivity.themeIndex]))
            ...
            searchActivity -> {
                holder.button.setOnClickListener {
                    when {
                        SongsFragment_ofMusicFragment.search -> sendIntent(ref = "MusicAdapterSearch", pos = position)
    ...
    fun refreshPlaylist(){
        musicList = ArrayList()
        musicList = PlaylistFragment.musicPlaylist.ref[PlaylistDetailsActivity.currentPlaylistPos].playlist
        notifyDataSetChanged()
    }
